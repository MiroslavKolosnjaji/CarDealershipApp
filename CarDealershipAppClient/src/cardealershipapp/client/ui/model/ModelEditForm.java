...
public class ModelEditForm extends javax.swing.JDialog {
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ModelEditController.update(txtId, txtModelName, comboBrands, this);
        dispose();
    ...
    private void populateCombo() {
      ModelEditController.populateCombo(comboBrands, this);
       
    }

    private void prepareForm() {
       ModelEditController.prepareForm(txtId, txtModelName, comboBrands,this);
    }
