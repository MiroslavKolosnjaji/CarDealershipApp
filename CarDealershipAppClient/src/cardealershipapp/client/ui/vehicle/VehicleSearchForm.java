...
public class VehicleSearchForm extends javax.swing.JDialog {
    ...
    private void comboBrandItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_comboBrandItemStateChanged
        VehicleSearchController.updateComboModel(comboBrand, comboModel, this);
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        VehicleSearchController.search(tblVehicles, comboBrand, comboModel, comboBodyType, comboYearFrom, comboYearTo, comboFuelType, comboCity, comboSortList, this);
        filtered = true;
//        comboSortList.setSelectedIndex(0);
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        VehicleSearchController.edit(tblVehicles, this);
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        ...
        if (!filtered) {
            ...
            VehicleSearchController.sortMainList(tblVehicles, comboSortList);
        }
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        VehicleSearchController.delete(tblVehicles, this);
    ...
    private void btnAddToPurchaseOrderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddToPurchaseOrderActionPerformed
        VehicleSearchController.addToPurchaseOrder(tblVehicles, this);
    ...
    private void infoArea() {
        VehicleSearchController.infoAdrea(txtAreaBusinessUnitInfo, tblVehicles, stringBuilder, this);
    }
    ...
    private void fillTable() {
        VehicleSearchController.fillTable(tblVehicles, this);
    }

    private void populateCombo() {
        VehicleSearchController.fillCombo(comboBrand, comboBodyType, comboFuelType, comboCity, comboYearFrom, comboYearTo, this);
    }

    private void loadPurchaseOrders() {
        VehicleSearchController.loadPurchaseOrders(this);
    }
